import { shuffleArray, generatePseudoRandomString } from "../lib/random.js";
  ...
  connectedCallback() {
    ...
    rows.forEach((row, i) => {
      const shuffledArray = shuffleArray(
        row.choices,
        generatePseudoRandomString([row.prefix, row.seed], 5)
      );
...
customElements.define("c-seeded-choice-table-3", SeededChoice);
